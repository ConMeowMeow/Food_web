...
<html lang="vi">
    ...
    <body>
        ...
        <section class="menu-section pt-5 pb-5 menu-page-bg" id="menu">
            <div class="container">
                <div class="row g-4">

                    <div class="col-lg-3">
                        <div class="sidebar-wrapper p-4 bg-white shadow-sm sticky-sidebar">
                            <h5 class="fw-bold mb-3 sidebar-heading">Các sản phẩm chỉ với giá</h5>
                            <div class="dual-slider-container position-relative mb-3 mt-4 price-slider-bg">
                                <div class="slider-track position-absolute price-slider-track" id="sliderTrack"></div>
                            ...
                            <div class="filter-box mb-4">
                                <h5 class="fw-bold mb-3 border-bottom pb-2 sidebar-heading">Loại sản phẩm</h5>
                            ...
                            <div class="filter-box">
                                <h5 class="fw-bold mb-3 border-bottom pb-2 sidebar-heading">Các Loại Combo</h5>
                    ...
                    <div class="col-lg-9">
                        <div class="d-flex justify-content-end align-items-center mb-4 pb-3">
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <select class="form-select border-0 shadow-sm text-dark ps-3 sort-select">
                        ...
                        <div class="row g-4" id="menu-grid">
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-12 food-item">
                                <div class="food-card position-relative h-100 d-flex flex-column border border-danger border-opacity-25"> 
                                    ...
                                    <button class="btn btn-wishlist position-absolute top-0 end-0 m-3 p-2 border-0 bg-transparent shadow-none">
                                    ...
                                    <div class="d-flex justify-content-between align-items-end mt-auto">
                                        ...
                                        <button class="btn btn-add-cart action-btn btn-outline-custom rounded-pill px-4 py-2 fw-bold d-flex align-items-center gap-2 btn-add-cart-sm">
