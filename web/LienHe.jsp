                ...
                <div class="row justify-content-center">
                    <div class="col-md-10 col-lg-8">
                        <div class="shopee-form-container">
                            <h3 class="fw-bold mb-4 text-center contact-title">Gửi Lời Nhắn Cho Chúng Tôi</h3>

                            <form id="contactForm" action="./XuLyLienHe" method="POST" novalidate>
                                <div class="mb-4">
                                    <label class="shopee-label"><span class="text-danger me-1 required-asterisk">*</span>Họ và tên</label>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-4">
                                        <label class="shopee-label"><span class="text-danger me-1 required-asterisk">*</span>Email</label>
                                    ...
                                    <div class="col-md-6 mb-4">
                                        <label class="shopee-label"><span class="text-danger me-1 required-asterisk">*</span>Số điện thoại</label>
                                ...
                                <div class="mb-4">
                                    <label class="shopee-label"><span class="text-danger me-1 required-asterisk">*</span>Bạn thắc mắc về vấn đề nào?</label>
                                ...
                                <div class="mb-4">
                                    <label class="shopee-label mb-0"><span class="text-danger me-1 required-asterisk">*</span>Nội dung phản hồi</label>
                                    <p class="text-muted mb-2 form-hint">Điền thêm thông tin chi tiết về thắc mắc/ vấn đề của bạn</p>
                                ...
                                <div class="mb-4 pt-2">
                                    <label class="form-label form-upload-label">Hãy tải lên hình ảnh/ clip thể hiện lỗi mà bạn đang gặp phải (nếu có)</label>
                                    <div class="mt-2">
                                        <h6 class="mb-1 fw-normal upload-title">Tải Lên Tập Tin</h6>
                                        <p class="text-muted mb-2 form-hint">Bạn có thể đính kèm tối đa 5 tệp với đuôi là jpg / jpeg / png / pdf / mp4 / xls / xlsx / csv / zip / doc / docx. Dung lượng mỗi tệp không quá 10 MB.</p>
                                ...
                                <div class="mb-4 d-flex align-items-start mt-4 pt-3 border-top">
                                    <div class="form-check ps-0 mb-0">
                                        <label class="form-check-label agreement-label" for="agreement">
                                            <span class="text-danger ms-0 me-1 required-asterisk">*</span>
                                ...
                                <div class="text-center mt-4">
                                    <button type="submit" class="btn text-white px-5 py-2 fw-bold btn-submit-contact">GỬI ĐI</button>
                                </div>
                            </form>
                        </div>
                    </div>
