...
<html lang="vi">
    ...
    <head>
        ...
        <title>Đặt Lại Mật Khẩu - Foodie</title>
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    ...
                    <div class="d-flex align-items-center flex-wrap justify-content-center gap-2 mt-3 mt-lg-0 pb-3 pb-lg-0">
                        ...
                        <div class="dropdown ms-2 position-relative">
                            <% if (!isLogged) { %>
                            <a href="#" class="text-primary-custom fs-4 text-decoration-none icon-action d-flex align-items-center justify-content-center icon-wrap-circle" id="accountDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-md-8 col-lg-5">
                        <div class="auth-card auth-card-custom">
                            <h2 class="auth-title mb-2">Tạo Mật Khẩu Mới</h2>
                            <p class="auth-subtitle auth-subtitle-custom text-muted mb-4">Vui lòng nhập mật khẩu mới cho tài khoản của bạn. Mật khẩu nên có ít nhất 6 ký tự.</p>
                            ...
                            <form id="resetPasswordForm" action="./XuLyDatLaiMatKhau" method="POST" novalidate>
                                ...
                                <div class="text-center mt-4">
                                    <button type="submit" class="btn btn-auth-custom text-white w-100 py-2 fs-5 fw-bold shadow-sm">
                                        ĐỔI MẬT KHẨU
                                    </button>
                                </div>
                            </form>
