...
<html lang="vi">
    ...
    <head>
        ...
        <style>
            ...
            button.btn-submit-register:hover {
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    ...
                    <div class="d-flex align-items-center flex-wrap justify-content-center gap-2 mt-3 mt-lg-0 pb-3 pb-lg-0">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end border-0 cart-dropdown-menu p-3 shadow" aria-labelledby="cartDropdown">
                                ...
                                <div class="cart-empty-guest text-center py-4">
                                    ...
                                    <div class="d-flex gap-2 justify-content-center">
                                        ...
                                        <a href="DangKi" class="btn btn-custom btn-sm w-50 text-decoration-none">Đăng ký</a>
                                    </div>
                                </div>
                        ...
                        <div class="dropdown ms-2 position-relative">
                            <% if (!isLogged) { %>
                            <a href="#" class="text-primary-custom text-dark fs-4 text-decoration-none icon-action d-flex align-items-center justify-content-center icon-wrap-circle" id="accountDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            ...
                            <ul class="dropdown-menu dropdown-menu-center border-0 shadow profile-dropdown-menu" aria-labelledby="accountDropdown">
                                ...
                                <li><a class="dropdown-item py-2 fw-semibold" href="./DangKi"><i class="fas fa-user-plus me-2 text-muted"></i> Đăng ký</a></li>
                            </ul>
                            <% } else { %>
                ...
                <div class="row justify-content-center">
                    <div class="col-md-10 col-lg-8">
                        <div class="auth-card">
                            ...
                            <p class="auth-subtitle">Tham gia cùng chúng tôi để nhận nhiều ưu đãi hấp dẫn</p>
                            <% if (request.getAttribute("error") != null) { %>
                            <div class="alert alert-danger text-center">
                                <%= request.getAttribute("error") %>
                            </div>
                            <% } %>
                            <form id="registerForm" action="./DangKy" method="POST" novalidate>
                                <div class="row">
                                    <div class="col-md-6 mb-4">
                                        <label for="fullname" class="form-label fw-semibold"><span class="text-danger me-1">*</span>Họ và tên</label>
                                        <input type="text" class="form-control shadow-none" id="fullname" name="fullname" placeholder="VD: Nguyễn Văn A" required>
                                        <div class="invalid-feedback">Vui lòng nhập họ và tên.</div>
                                    </div>
                                    <div class="col-md-6 mb-4">
                                        <label for="email" class="form-label fw-semibold"><span class="text-danger me-1">*</span>Địa chỉ Email</label>
                                        <input type="email" class="form-control shadow-none" id="email" name="email" placeholder="Nhập email" required>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-4">
                                        <label for="phone" class="form-label fw-semibold"><span class="text-danger me-1">*</span>Số điện thoại</label>
                                        <input type="tel" class="form-control shadow-none" id="phone" name="phone" placeholder="Nhập số điện thoại" required>
                                        <div class="invalid-feedback">Vui lòng nhập số điện thoại hợp lệ.</div>
                                    </div>
                                    <div class="col-md-6 mb-4">
                                        <label for="address" class="form-label fw-semibold"><span class="text-danger me-1">*</span>Địa chỉ giao hàng</label>
                                        <input type="text" class="form-control shadow-none" id="address" name="address" placeholder="Nhập địa chỉ" required>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-4">
                                        ...
                                        <input type="password" class="form-control shadow-none" id="password" name="password" placeholder="Tạo mật khẩu" required>
                                    ...
                                    <div class="col-md-6 mb-4">
                                        ...
                                        <input type="password" class="form-control shadow-none" id="confirmPassword" name="confirmPassword" placeholder="Nhập lại mật khẩu" required>
                                ...
                                <div class="mb-4">
                                    <div class="form-check">
                                        <input class="form-check-input shadow-none border-secondary" type="checkbox" id="agreeTerms" required>
                                        <label class="form-check-label text-muted small" for="agreeTerms">
                                            Tôi đồng ý với các <a href="Policy" class="text-primary-custom text-decoration-none">Điều khoản dịch vụ</a> và <a href="Policy" class="text-primary-custom text-decoration-none">Chính sách bảo mật</a>.
                                        </label>
                                ...
                                <div class="text-center mt-4">
                                    <button type="submit" class="btn text-white w-100 py-2 fs-5 mb-3 fw-bold shadow-sm btn-submit-register">ĐĂNG KÝ</button>
                                </div>

                                <div class="text-center mt-3 border-top pt-3">
                                    <span class="text-muted small">Đã có tài khoản?</span> 
                                    <a href="DangNhap" class="text-primary-custom text-decoration-none fw-bold small">Đăng nhập ngay</a>
                                </div>
                            </form>
                        </div>
                    </div>
