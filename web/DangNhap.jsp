                    ...
                    <div class="d-flex align-items-center flex-wrap justify-content-center gap-2 mt-3 mt-lg-0 pb-3 pb-lg-0">
                        ...
                        <div class="dropdown ms-2 position-relative" id="cartDropdownContainer">
                            <%
                                ...
                                boolean isLogged = (userAccount != null);
                                
                                List<CartItem> cartList = new java.util.ArrayList<>();
                                int cartSize = 0;
                                double totalCartPrice = 0;

                                if (isLogged) {
                                    CartDAO cdao = new CartDAO();
                                    cartList = cdao.getCartItems(userAccount.getId());
                                    cartSize = cartList.size();
                                    for (CartItem item : cartList) {
                                        totalCartPrice += item.getPrice() * item.getQuantity();
                                    }
                                }
                                boolean hasItemsInCart = (cartSize > 0);
                ...
                <div class="row justify-content-center">
                    <div class="col-md-8 col-lg-5">
                        <div class="auth-card">
                            ...
                            <% } %>
                            <form id="loginForm" action="./DangNhap" method="POST" novalidate>
                                <div class="mb-4">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="password" class="form-control shadow-none" id="password" name="password" placeholder="Nhập mật khẩu" required>
                                ...
                                <div class="d-flex justify-content-between align-items-center mb-4">
                                    ...
                                    <a href="./ForgotPassword" class="text-primary-custom text-decoration-none small fw-semibold">Quên mật khẩu?</a>
                                </div>

                                <div class="text-center mt-4">
                                    <button type="submit" class="btn text-white w-100 py-2 fs-5 mb-3 fw-bold shadow-sm btn-submit-login">ĐĂNG NHẬP</button>
                                </div>

                                <div class="text-center mt-3 border-top pt-3">
                                    <span class="text-muted small">Chưa có tài khoản?</span> 
                                    <a href="DangKy" class="text-primary-custom text-decoration-none fw-bold small">Đăng ký ngay</a>
                                </div>
                            </form>
                        </div>
                    </div>
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function () {
                ...
                form.addEventListener('submit', function (event) {
                    ...
                    // Xóa tất cả trạng thái báo lỗi (is-invalid) cũ trước khi kiểm tra
                    ...
                    // CHỈ chặn gửi form khi dữ liệu NHẬP SAI (isValid == false)
                    if (!isValid) {
                        event.preventDefault();
                    }
                    // Nếu isValid == true, trình duyệt sẽ tự động gửi dữ liệu đến url "./DangNhap"
                });
            });
        </script>
    </body>
