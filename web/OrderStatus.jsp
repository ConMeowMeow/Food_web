                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered custom-order-table mb-0">
                            <thead class="table-light">
                                <tr>
                                    <th scope="col" class="col-order-id">Mã đơn hàng</th>
                                    <th scope="col" class="col-date">Ngày đặt</th>
                                    <th scope="col" class="col-details">Chi tiết món</th>
                                    <th scope="col" class="col-price">Giá tiền</th>
