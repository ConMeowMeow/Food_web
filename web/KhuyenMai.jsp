    ...
    <body>
        ...
        <section class="shopee-voucher-section py-5">
            <div class="container">
                <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-4 gap-3">
                    ...
                    <div class="d-flex bg-white p-2 rounded-0 shadow-none border voucher-box voucher-search-box">
                        <input type="text" class="form-control border-0 shadow-none bg-transparent voucher-search-input" placeholder="Nhập mã voucher (vd: SALE50)...">
                        <button type="button" class="btn text-white px-4 fw-bold btn-save-voucher">Lưu</button>
                    </div>
                </div>
                    ...
                    <div class="col-lg-6">
                        <div class="shopee-voucher">
                            ...
                            <div class="v-left bg-shopee-red p-2">
                                ...
                                <span class="fw-bold mt-1 v-brand-name">FOODIE</span>
                                <span class="fw-bold v-mall-text">MALL</span>
                            </div>
                            <div class="v-right">
                                <div class="v-info pe-2">
                                    ...
                                    <p class="text-muted small mb-0 d-flex align-items-center">
                                        ...
                                        <a href="#" class="text-primary text-decoration-none ms-2" data-bs-toggle="modal" data-bs-target="#voucherModal">ĐK</a>
                                    </p>
                                </div>
                ...
                <div class="row g-4">
                    <div class="col-lg-3 col-md-6">
                        <div class="food-card position-relative h-100 border border-danger border-opacity-25">
                            ...
                            <button class="btn btn-wishlist position-absolute top-0 end-0 m-3 p-2 border-0 bg-transparent shadow-none wishlist-btn-pos">
                            ...
                            <div class="d-flex justify-content-between align-items-end">
                                ...
                                <button class="btn btn-add-cart action-btn btn-outline-custom rounded-pill px-4 py-2 fw-bold d-flex align-items-center gap-2 add-cart-text">
        ...
        <div class="modal fade" id="voucherModal" tabindex="-1" aria-labelledby="voucherModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                <div class="modal-content shopee-modal-content">
                    <div class="shopee-modal-header-accent"></div>

                    <div class="modal-body p-0">
                        <div class="voucher-ticket-container m-3 d-flex">
                            <div class="v-left bg-shopee-red p-2">
                                <div class="mb-1 border border-white p-1 rounded"><i class="fas fa-shopping-bag fs-4"></i></div>
                                <span class="fw-bold mt-1 v-brand-name">FOODIE</span>
                                <span class="fw-bold v-mall-text">MALL</span>
                            </div>
                            <div class="voucher-right flex-grow-1 bg-white p-3 border border-start-0">
                                <h5 class="voucher-main-title fw-bold">Giảm 95% tối đa 1 Triệu</h5>
                                <p class="min-spend text-muted mb-1">Min. Spend 1mđ</p>
                                <p class="use-info text-muted small"><i class="bi bi-clock me-1"></i> Use in: 2 days</p>
                            </div>
                        </div>

                        <div class="claim-info text-danger px-3 mb-3 small">
                            <i class="bi bi-clock me-1"></i> Claim in: 2 days
                        </div>

                        <div class="details-section px-3 pb-3">
                            <h6 class="detail-header fw-bold text-uppercase text-muted">Valid Period</h6>
                            <p class="detail-content text-muted">11 May 2026 00:00 - 17 May 2026 23:59</p>

                            <h6 class="detail-header fw-bold text-uppercase text-muted">Reward</h6>
                            <p class="detail-content"><a href="./ThucDon.jsp" class="text-decoration-none">Mua sắm ngay tại đây</a></p>

                            <h6 class="detail-header fw-bold text-uppercase text-muted">Payment</h6>
                            <ul class="detail-content list-unstyled text-muted ps-3">
                                <li>• NAPAS cards</li>
                                <li>• Google Pay</li>
                                <li>• Apple Pay</li>
                            ...
                            <h6 class="detail-header fw-bold text-uppercase text-muted">More Details</h6>
                            <p class="detail-content text-muted">Sử dụng mã giảm 95% tối đa 1 Triệu Đồng cho đơn hàng từ 1 Triệu Đồng và thỏa điều kiện ưu đãi<br>
                                Đơn vị vận chuyển khả dụng: Hàng Cồng Kềnh.<br>
                                Đơn vị vận chuyển khả dụng: Nhanh - Shopee Xử Lý khi mua sản phẩm có nhãn Xử lý bởi Shopee<br>
                    ...
                    <div class="modal-footer p-0 border-0">
                        <button type="button" class="btn btn-shopee-ok w-100 rounded-0 py-3 fw-bold" data-bs-dismiss="modal">OK</button>
                    </div>
                </div>
            </div>
        </div>
