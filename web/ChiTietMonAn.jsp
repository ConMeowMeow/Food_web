        ...
        <main class="container product-detail-container">
            <div class="d-flex justify-content-end mb-4">
                <a href="ThucDon.jsp" class="btn-back">
                    <i class="fas fa-chevron-left fa-xs me-1"></i> Quay lại
                </a>
            </div>
            ...
            <div class="row g-5 food-card text-start">
                <div class="col-lg-6 pe-lg-4">
                    <div class="text-center mb-4">
                        <img src="https://images.unsplash.com/photo-1626082927389-6cd097cdc6ec?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" alt="Combo Tiện Lợi 2" class="img-fluid product-main-img">
                    </div>
                ...
                <div class="col-lg-6 ps-lg-4 d-flex flex-column">
                        ...
                        <div class="option-body">
                            <div class="option-item addable-item" data-price="0" data-max="1">
                                <div class="d-flex align-items-center gap-3 user-select-none">
                                    <span class="item-qty fw-bold item-qty-color hidden-elem" data-qty="0">0x</span>
                                ...
                                <div class="d-flex align-items-center gap-2">
                                    ...
                                    <i class="fas fa-times-circle remove-icon hidden-elem" title="Bỏ chọn"></i>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="option-body">
                            <div class="option-item addable-item" data-price="7000" data-max="99">
                                ...
                                <div class="d-flex align-items-center gap-2">
                                    ...
                                    <i class="fas fa-times-circle remove-icon hidden-elem" title="Giảm số lượng"></i>
                                </div>
                            </div>
                    ...
                    <div class="d-flex flex-wrap justify-content-between align-items-center mt-auto pt-4">
                        <div class="d-flex align-items-center gap-3 mb-3 mb-sm-0">
                            <span class="text-dark fs-6">Số lượng</span>
                        ...
                        <div class="d-flex align-items-center gap-3">
                            <button class="btn btn-wishlist border-0 shadow-none p-0 d-flex align-items-center justify-content-center wishlist-btn-size">
