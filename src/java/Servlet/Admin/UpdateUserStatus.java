...
public class UpdateUserStatus extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (userIdStr != null && statusStr != null) {
            ...
            // Ép kiểu: Nút "Active" gửi lên -> set byte = 1. Ngược lại là 0.
            byte newStatus = (byte) (statusStr.equals("Active") ? 1 : 0);

            UserDAO dao = new UserDAO();
            dao.updateUserStatus(userId, newStatus);
        }

        // Sau khi update xong, load lại trang Quản lý khách hàng
